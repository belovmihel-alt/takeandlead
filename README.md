...
### Первый раз устанавливаете?
📖 **[SETUP.md](SETUP.md)** - Подробная пошаговая инструкция для начинающих (полный нуль в программировании)

### Уже установили и настроили?
⚡ **[QUICK_START.md](QUICK_START.md)** - Краткая инструкция для ежедневного запуска

### Возникли вопросы или проблемы?
❓ **[FAQ.md](FAQ.md)** - Ответы на часто задаваемые вопросы

### Нужна документация API?
📚 **[docs/API.md](docs/API.md)** - Полная документация API эндпойнтов
